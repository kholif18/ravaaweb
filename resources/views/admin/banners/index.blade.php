...
<div class="table-toolbar" style="display:block !important;">
    <div class="toolbar-group" style="display:block !important;">
        <div style="display:flex !important; align-items:center; gap:8px; flex-wrap:nowrap !important; white-space:nowrap;">
            ...
            <button type="button" class="btn btn-light btn-sm" id="kt_banner_reset_filter" style="flex-shrink:0;">
            ...
            <form id="kt_modal_edit_banner_form" method="POST" data-update-url="{{ route('admin.banners.update', ':id') }}">
                ...
                <div class="modal-body py-4 px-4">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="hidden" name="image" id="edit_banner_image">
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6 fv-row">
                            <label class="fs-7 fw-semibold mb-1">Teks CTA</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.editBanner = async function(id) {
        ...
        if (data.success) {
            ...
            const imgCol = document.getElementById('edit_banner_image');
            if (imgCol) imgCol.value = b.image || '';
                ...
                if (b.image_media_id && b.media_url) {
                    previewContainer.innerHTML = `
                        <div class="media-picker-thumb">
                            ...
                            <button type="button" class="remove-media" onclick="removePickerItem('edit_image_media_id', '${b.image_media_id}'); document.getElementById('edit_banner_image').value='';"><i class="bi bi-x"></i></button>
                        </div>
                    `;
                } else if (b.image) {
                    const imgUrl = b.image.startsWith('http') ? b.image : '/storage/' + b.image;
                    previewContainer.innerHTML = `
                        <div class="media-picker-thumb">
                            <img src="${imgUrl}" alt="Preview">
                            <button type="button" class="remove-media" onclick="removePickerItem('edit_image_media_id', ''); document.getElementById('edit_banner_image').value='';"><i class="bi bi-x"></i></button>
                        </div>
                    `;
                } else {
                    previewContainer.innerHTML = `
